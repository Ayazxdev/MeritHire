...
export default function CompanyCandidateReview({ candidate, onBack, onAction }) {
    ...
    // Mock detailed data augmenting the passed candidate prop
    const details = {
        ...candidate,
        skills: ['React', 'JavaScript', 'System Thinking'],
        insights: [
            { label: 'Start Time', value: '09:00 AM' },
            { label: 'Completion', value: '100% Verified' }
        ],
        agentNotes: "GitHub projects show production-level React usage. Resume context aligns with repository activity.",
        biasStatus: "No demographic influence detected. All identifiers stripped.",
        reviewTrigger: candidate.confidence < 85 ? "Skill confidence near role threshold." : null
    };

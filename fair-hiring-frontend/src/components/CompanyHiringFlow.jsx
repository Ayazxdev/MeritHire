  ...
  const handlePublish = async () => {
    ...
    try {
      ...
      if (companyId) {
        ...
        console.warn("No fhn_company_id in localStorage — job not persisted");
      }
    } catch (e) {
                ...
                <div className="space-y-6">
                  ...
                  {jobDescription.length > 0 && (
                    <div className="flex gap-4 p-4 bg-black/[0.03] border-[1px] border-[#1c1c1c]/10 items-center">
                      ...
                      <span className="font-grotesk text-[9px] font-black uppercase tracking-widest">
                        Live Analysis: Language pattern optimization active
                      </span>
                    </div>
                  )}
                </div>
